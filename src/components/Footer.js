         ...
         <div className='ft1 pt-5'>
                <Row>
                    <Col lg={3} md={3} sm={3} xs={3} className='ms-5'>
                        ...
                        <Row className='w-50 container text-center' style={{ position: 'relative', left: '25%' }}>
                ...
                <Row className='pt-4'>
                    <Col lg={12} md={12} sm={12} xs={12} className='w-25 container'>
                        <p>We are liability insured with if. With an insurance sum up to 10 million.</p>
                    </Col>
                </Row>
                <hr />
                <Row>
                    <Col lg={12} md={12} sm={12} xs={12} className='w-50 container'>
